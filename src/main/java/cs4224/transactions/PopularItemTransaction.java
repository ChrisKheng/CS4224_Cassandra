...
public class PopularItemTransaction extends BaseTransaction {
    ...
    public void execute(String[] dataLines, String[] parameters) {
        ...
        // Order -> max_quantity
        final Map<Order, BigDecimal> orderQuantity = new HashMap<>();
        // OrderId -> items
        final Map<Integer, List<Integer>> orderItems = new HashMap<>();
        ...
        orderItems.values().forEach(itemList -> items.addAll(itemList));
        ...
        printOutput(warehouseId, districtId, L, orderQuantity, orderItems, customerMap, itemPopularity, itemName);
    }
